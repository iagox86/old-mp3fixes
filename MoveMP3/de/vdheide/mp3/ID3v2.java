// ID3v2.java
//
// $Id: ID3v2.java,v 1.1 2004/07/26 20:47:48 iago Exp $
//
...
public class ID3v2
{
    ...
    public void update() throws IOException
    {
        ...
        if (is_changed == true) 
        {
            ...
            ID3v2ExtendedHeader new_ext_header = new ID3v2ExtendedHeader(use_crc, crc, 0);
            ...
            if (use_padding == true)
            {
                ...
                if (write_to != file)
                {
                    ...
                    padding = (long)(Math.ceil(res_file_size / 2048) * 2048) - res_file_size;
                }
                else
                {
            ...
            if (write_to != file)
            {
                ...
                for (int i=length_file - 1; i<file.length(); i++)
                {
                    out.write(copy_out.read());
                }
                copy_out.close();
            }
     ...
     *
     */
    private void readFrames(InputStream in) throws IOException, ID3v2WrongCRCException, 
    ID3v2DecompressionException
    {
